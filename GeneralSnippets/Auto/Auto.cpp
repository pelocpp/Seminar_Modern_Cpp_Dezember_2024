...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        auto q = 123.456;   // Type Deduction // Typableitung 

        // C++ : Konstanten in C/C++
        //  ====> Jeder Konstanten: Datentyp.
    ...
    //auto tueWas(bool flag, float f, double d) -> double
    //{
    //    if (flag) {
    //        return d;
    //    }
    ...
    auto tueWas2(bool flag, T f, U d) -> decltype (f + d)
    {
        if (flag) {
            return d;
        }
    ...
    void test_tue_was()
    {
        ...
        auto result = tueWas (false, 123, 123);  // Template Parameter Deduction
    }
